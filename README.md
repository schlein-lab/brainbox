...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-1.0.2-16a34a">
  <a href="https://get.brainarbeit.com/brainbox-installer-amd64-1.0.2.iso"><img alt="Download installer ISO" src="https://img.shields.io/badge/download-installer%20ISO-0d9488"></a>
...
1. Download **[`brainbox-installer-amd64-1.0.2.iso`](https://get.brainarbeit.com/brainbox-installer-amd64-1.0.2.iso)**
   (~2.9 GB) and, if you like, verify it against its
   [SHA-256](https://get.brainarbeit.com/brainbox-installer-amd64-1.0.2.iso.sha256).
...
### 1.0.2
- **Access credentials** - the console/sudo password (and root via `sudo -i`) is now always retrievable: it is shown once in the setup result and kept in `/etc/brainbox/access.txt` on the box. Leaving the password field blank keeps the current one - it is never silently rotated.
- **Setup wizard** - the optional-settings step no longer appears to stall: a validation error now always surfaces (its section opens and scrolls into view).

Installer: [`brainbox-installer-amd64-1.0.2.iso`](https://get.brainarbeit.com/brainbox-installer-amd64-1.0.2.iso) - [SHA-256](https://get.brainarbeit.com/brainbox-installer-amd64-1.0.2.iso.sha256)
