...
# Der Banner steht ABSICHTLICH vor firstboot: firstboot laeuft beim allerersten Start eine
...
menuentry "Brainbox (pn-init)" {
    # Das Menue ist unsichtbar (timeout 0), dieser Text aber nicht: er steht auf dem
    # Bildschirm, waehrend der Kernel geladen wird und sonst nichts zu sehen waere.
