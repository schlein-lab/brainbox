...
OUT = os.environ.get("OUT", "kernel/initramfs-cell-luks.cpio")
...
echo ""
echo "PN_VMM_CELL_LUKS_INITRAMFS_ALIVE"
echo "PN_LUKS_MODE=HOST_SIDE_DECRYPT (guest kernel lacks device-mapper)"
echo -n "PN_LUKS_VDB_MAGIC="; busybox dd if=/dev/vdb bs=1 count=4 2>/dev/null | busybox od -A n -c | busybox tr -d ' \\n'; echo " (NOT 'LUKS' -> host handed us the DECRYPTED mapper)"
